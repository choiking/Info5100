...
public class BrowseProducts extends javax.swing.JPanel {
    ...
    public void refresProductTable(String keyword){
        DefaultTableModel model = (DefaultTableModel)productTable.getModel();
        model.setRowCount(0);
         for (Supplier s : supplierDirectory.getSupplierlist()){
        ...
        // TODO add your handling code here:
          int selectedrow= productTable.getSelectedRow();
            ...
            JOptionPane.showMessageDialog(null, "Pls select a row!!", "Warning", JOptionPane.WARNING_MESSAGE);
                 ...
                 if(fetchQty<=0){
            JOptionPane.showMessageDialog(null, "Quantity Cannot be lesst than 0");
            return;
        }
          try{
            double salesPrice = Double.parseDouble(txtSalesPrice.getText());
               ...
               {
            JOptionPane.showMessageDialog(null, "SalesPrice cannot be less than actural price");
            return;
                }
    ...
    private void btnRemoveOrderItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveOrderItemActionPerformed
        ...
        order.removeOrderItem(oi);
         JOptionPane.showMessageDialog(null, "Order Item Remove rrom the cart");
          refresOrderTable();
          populateTable();
