...
public class ManageEnterpriseAdminJPanel extends javax.swing.JPanel {
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        switch (enterpriseTypeJComboBox.getSelectedItem().toString()) {
            case "Company":
                enterprise.getUserAccountDirectory().createUserAccount(username, password, employee, new CompanyAdminRole());
                break;
            case "Orphanage":
                enterprise.getUserAccountDirectory().createUserAccount(username, password, employee, new OrphanageAdminRole());
                break;
            case "School":
                enterprise.getUserAccountDirectory().createUserAccount(username, password, employee, new SchoolAdminRole());
                break;
        }
        populateTable();
    ...
    private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtnActionPerformed
        // TODO add your handling code here:
        String userName = enterpriseJTable.getValueAt(enterpriseJTable.getSelectedRow(), 3).toString();
        Enterprise enterprise = (Enterprise)enterpriseJTable.getValueAt(enterpriseJTable.getSelectedRow(), 0);
