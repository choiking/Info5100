...
public class BrowseProductsJPanel extends javax.swing.JPanel {
    ...
    BrowseProductsJPanel(JPanel userProcessContainer, List<Retailer> retailerList,
            MasterOrderCatalog masterOrderCatalog, CustomerDirectory customerDirectory, Customer c) {
        initComponents();
    ...
    public void populateRetailerCombobox() {
        retailerComboBox1.removeAllItems();

        for (Retailer retailer : retailerList) {
            retailerComboBox1.addItem(retailer);
        }
        populateTable();
    }
    ...
    public void populateTable() {
        try {
            ...
            model.setRowCount(0);
            //Retailer retailer = (Retailer) retailerComboBox1.getSelectedItem();
            for (Retailer r : retailerList) {
                for (Product product : r.getProductCatalog().getProductCatalog()) {
            ...
            JOptionPane.showMessageDialog(null, "Please add a retailier and then click the button");
        }
    }
    ...
    public void refreshProductTable(String keyword) {
        DefaultTableModel model = (DefaultTableModel) productTable.getModel();
        //model.setRowCount(0);
        for (Retailer supplier : retailerList) {
    ...
    private void initComponents() {
        ...
        retailerComboBox1 = new javax.swing.JComboBox();
        ...
        productTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Product Name", "Product Id", "Price", "Availability", "Retailer"
            }
        ) {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 200, 640, 110));

        retailerComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "--Select--" }));
        retailerComboBox1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                retailerComboBox1ActionPerformed(evt);
            }
        });
        add(retailerComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 140, 250, -1));
        ...
        jLabel2.setText("Retailer Product Catalog");
        ...
        jLabel4.setText("Shopper's Haunt");
    ...
    private void addtoCartButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addtoCartButton6ActionPerformed
        ...
        if (fetchQty <= 0) {
            JOptionPane.showMessageDialog(null, "Quantity cannot be less trhan or equal to 0");
            return;
        }
...
//            }
    ...
    private void btnCheckOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckOutActionPerformed
        ...
        if (order.getOrderItemList().size() > 0) {
            ...
            for (int i = 0; i < orderTable.getRowCount(); i++) {
                double amount = (Double) orderTable.getValueAt(i, 3);
                total += amount;
            }
            ...
            populateTable();
            isCheckedOut = true;
            customer.getPayment().setTotalAmount(String.valueOf(total));

            PaymentJPanel vpdjp = new PaymentJPanel(userProcessContainer, customerDirectory, customer);
            userProcessContainer.add("PaymentJPanel", vpdjp);
            CardLayout layout = (CardLayout) userProcessContainer.getLayout();
            layout.next(userProcessContainer);
        } else {
    ...
    private void btnModifyQuantityActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModifyQuantityActionPerformed
        ...
        if (txtNewQuantity.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Please input new quantity!");
        }
        int newQty = Integer.parseInt(txtNewQuantity.getText());
        if (newQty > (currentAvail + oldQty)) {
            JOptionPane.showMessageDialog(null, "Quantity is more tham availability");
            return;
        } else {
            if (newQty <= 0) {
    ...
    private void retailerComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_retailerComboBox1ActionPerformed
        // TODO add your handling code here:
        populateTable();
    }//GEN-LAST:event_retailerComboBox1ActionPerformed
    ...
    private javax.swing.JComboBox retailerComboBox1;
